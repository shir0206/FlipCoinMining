...
//	public static final String SQL_Transaction_update (String block, String trans) {
//		return "UPDATE tblTransaction SET tblTransaction.blockAddress = " + block + "\r\n" + 
//				"WHERE (tblTransaction.ID = " + trans 
//				+ ");\r\n" + 
//				"";
//	}
